...
import MainVector from "@/Assets/images/VectorTwo.svg"
import TrustVector from "@/Assets/images/VectorThree.svg"
import SupportVector from "@/Assets/images/VectorFour.svg"
                ...
                <div className=" flex flex-col justify-center items-center gap-12">
                    ...
                    <div className="grid grid-cols-4 gap-4 w-full">
                        <div className="bg-white col-span-1 p-6 shadow-md w-full rounded-md text-center flex flex-col justify-center items-center">
                            <img src={Attendance} className="bg-primary-2 w-20 h-20 p-4 rounded-full"/>
                        ...
                        <div className="bg-white col-span-1 p-6 shadow-md w-full rounded-md text-center flex flex-col justify-center items-center">
                            <img src={Reports} className="bg-primary-2 w-20 h-20 p-4 rounded-full"/>
                            <p className="font-PoppinsBold text-xl my-4">
                                Reports
                            </p>
                            <p className="font-PoppinsRegular text-base">
                        ...
                        <div className="bg-white col-span-1 p-6 shadow-md w-full rounded-md text-center flex flex-col justify-center items-center">
                            <img src={Activity} className="bg-primary-2 w-20 h-20 p-4 rounded-full"/>
                            <p className="font-PoppinsBold text-xl my-4">
                                Activity
                            </p>
                            <p className="font-PoppinsRegular text-base">
                        ...
                        <div className="bg-white col-span-1 p-6 shadow-md w-full rounded-md text-center flex flex-col justify-center items-center">
                            <img src={Tracking} className="bg-primary-2 w-20 h-20 p-4 rounded-full"/>
                            <p className="font-PoppinsBold text-xl my-4">
                                Tracking
                            </p>
                            <p className="font-PoppinsRegular text-base">
                ...
                <div className="bg-white grid grid-cols-2 p-20">
                    ...
                    <div className="col-span-1 gap-2 flex flex-col justify-center">
                        ...
                        <div className="p-6 w-full rounded-md flex items-center gap-4">
                            <img src={Support} className="bg-primary-3 w-16 h-16 rounded-lg"/>
                            <div className="">
                        ...
                        <div className="p-6 w-full rounded-md flex items-center gap-4">
                            <img src={Response} className="bg-primary-3 w-16 h-16 rounded-lg"/>
                            <div className="">
                                <p className="font-PoppinsSemiBold text-xl">
                                    1.5 hour
                                </p>
                        ...
                        <div className="p-6 w-full rounded-md flex items-center gap-4">
                            <img src={Happiness} className="bg-primary-3 w-16 h-16 rounded-lg"/>
                            <div className="">
                                <p className="font-PoppinsSemiBold text-xl">
                                    99%
                                </p>
